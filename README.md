...
The through-line from Optum to Ally is the same instinct: **the model is the easy part.** Evaluation, grounding, PHI/PII controls, cost, and audit trails are what get AI past a governance review — in healthcare and in banking alike. That's why my projects ship with tests, gates, and monitoring instead of just a nice demo.

> **AI/ML in healthcare → AI/ML in finance. Production AI where "it works in the demo" never ships.**
